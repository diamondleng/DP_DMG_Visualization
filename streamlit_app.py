...
with cols[1]:
    st.markdown("### Legend")
    st.markdown(f"**{label}**")
    st.markdown(f"<div style='background: linear-gradient(to right, blue, cyan, green, yellow, orange, red); height: 15px; width: 100%; margin-bottom: 5px;'></div>", unsafe_allow_html=True)
